...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 this->label1->Text = L"相似度:" + similar.ToString() + "\n字符串1长度:" + len1.ToString() + " 字符串2长度:" + len2.ToString() + "  执行时间:" + t.ToString() + " 毫秒";
				 //System::Windows::Forms::MessageBox::Show(L"相似度：" + similar.ToString() + "  字符串长度：" + len.ToString() + "  执行时间：" + tc.ToString() + " - "+ tc2.ToString() + " 毫秒");
				 free(p);
				 free(p2);
	}
